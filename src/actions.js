...
export const GET_SINGLE_POPULAR_BEGIN = "GET_SINGLE_POPULAR_BEGIN";
export const GET_SINGLE_POPULAR_SUCCESS = "GET_SINGLE_POPULAR_SUCCESS";
export const GET_SINGLE_POPULAR_ERROR = "GET_SINGLE_POPULAR_ERROR";
